...
class TestTorchSwiss(unittest.TestCase):
    ...
    def test_model_holder(self):
        from torch_swiss.model import ModelHolder
    ...
    def test_compute_word_piece_padding(self):
        from torch_swiss import compute_word_piece_padding
        ...
        new_start,new_end = compute_word_piece_padding(tokenizer,document_tokens,140,141,init_padding_count=1)
        
        self.assertEqual(new_start,168)
        self.assertEqual(new_end,169)
        
        new_start,new_end = compute_word_piece_padding(tokenizer,document_tokens,167,168,init_padding_count=1)
